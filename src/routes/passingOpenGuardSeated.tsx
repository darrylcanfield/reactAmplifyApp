      ...
      {notification && (
        ...
        <Col>
          <Card>
            <Card.Body>
            <Row>
            <h3 className="text-center">Passing Open Guard (Seated):</h3>
            </Row>
              <Row>
                <Col>
                    <video 
                ...
                <Col>
                <h5><strong>Shoulder Push Foot Lift:</strong></h5>
                   <p>Shoulder push, 2 on 1 grip on the foot, pulling and lifting.
                   </p>
                   <Button
  variant="primary"
  onClick={() => {
...
>
  ⭐ save
              ...
              <Row>
                ...
                <a href="https://www.youtube.com/watch?v=xnMtsEidnsQ">Andrew Tacket vs Eoghan O'Flanagan (00.05)</a><br /></p>       
                </Col>
              ...
              {data
              .filter((item) => item.sub === "passingOpenGuardSeated")  // Filter items where 'sub' equals "attackingOpenGuard"
              .map((item) => (
...
export default passingOpenGuardSeated;
