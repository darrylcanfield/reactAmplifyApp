          ...
          <Card>
            <Card.Body>
              ...
              <Row>
                ...
                {data
                  .filter((item) => item.sub === "attackingChoiGuard")  // Filter items where 'sub' equals "attackingOpenGuard"
                  .map((item) => (
...
export default AttackingChoiGuard;
