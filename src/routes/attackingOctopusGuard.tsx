          ...
          <Card>
            <Card.Body>
              ...
              <Row>
                ...
                {data
                  .filter((item) => item.sub === "attackingOctopusGuard")  // Filter items where 'sub' equals "attackingOpenGuard"
                  .map((item) => (
...
export default AttackingOctopusGuard;
