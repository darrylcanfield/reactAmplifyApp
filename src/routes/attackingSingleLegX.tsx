          ...
          <Card>
            <Card.Body>
              ...
              <Row>
                ...
                {data
                  .filter((item) => item.sub === "attackingSingleLegX")  // Filter items where 'sub' equals "attackingOpenGuard"
                  .map((item) => (
...
export default attackingSingleLegX;
