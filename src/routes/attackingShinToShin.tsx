          ...
          <Card>
            <Card.Body>
              ...
              <Row>
                ...
                {data
                  .filter((item) => item.sub === "attackingShinToShin")  // Filter items where 'sub' equals "attackingOpenGuard"
                  .map((item) => (
...
export default AttackingShinToShin;
