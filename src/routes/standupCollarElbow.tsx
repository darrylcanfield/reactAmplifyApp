...
const ComponentA = lazy(() => import("./passingHalfGuard"));
const ComponentB = lazy(() => import("./passingOpenGuard"));
const ComponentC = lazy(() => import("./passingSingleLegX"));

const StandupCollarElbow = () => {
