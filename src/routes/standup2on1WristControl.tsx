          ...
          <Card>
            <Card.Body>
              ...
              <Row>
                ...
                {data
                  .filter((item) => item.sub === "standup2on1WristControl")  // Filter items where 'sub' equals "attackingOpenGuard"
                  .map((item) => (
...
export default Standup2on1WristControl;
