          ...
          <Card>
            <Card.Body>
              ...
              <Row>
                ...
                {data
                  .filter((item) => item.sub === "attackingOutsideAshi")  // Filter items where 'sub' equals "attackingOpenGuard"
                  .map((item) => (
...
export default AttackingOutsideAshi;
