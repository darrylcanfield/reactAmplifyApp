            ...
            <Card.Body>
              ...
              <Row>
                <h4 className="text-center">Choose your opponent's reaction:</h4>
                 {data
                  .filter((item) => item.sub === "passingButterflyGuard")  // Filter items where 'sub' equals "attackingOpenGuard"
                  .map((item) => (
...
export default passingButterflyGuard;
