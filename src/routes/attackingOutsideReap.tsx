          ...
          <Card>
            <Card.Body>
              ...
              <Row>
                ...
                {data
                  .filter((item) => item.sub === "attackingOutsideReap")  // Filter items where 'sub' equals "attackingOpenGuard"
                  .map((item) => (
...
export default AttackingOutsideReap;
