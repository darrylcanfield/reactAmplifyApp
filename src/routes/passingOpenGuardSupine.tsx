...
function createTodo2() {
  const content = "Circling Pass"; // Set content explicitly
      ...
      {notification && (
        ...
        <Col>
          <Card>
            <Card.Body>
            <Row>
            <h3 className="text-center">Passing Open Guard (Supine):</h3>
            </Row>
              <Row>
                <Col>
                    <video 
...
>
  ⭐ save
              ...
              {data
              .filter((item) => item.sub === "passingOpenGuardSupine")  // Filter items where 'sub' equals "attackingOpenGuard"
              .map((item) => (
...
export default passingOpenGuardSupine;
