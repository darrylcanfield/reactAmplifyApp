      ...
      {notification && (
        ...
        <Col>
          <Card>
            <Card.Body>
            <Row>
            <h3 className="text-center">Passing Headquarters:</h3>
            </Row>
              <Row>
                <Col>
                    <video 
                ...
                <Col>
                <h5><strong>Pancake Pass:</strong></h5>
                   <p>Smash the knee, cover with your chest, windshield wiper legs to pass.
                   </p>
                   <Button
  variant="primary"
  onClick={() => {
...
>
  ⭐ save
              ...
              {data
              .filter((item) => item.sub === "passingHeadquarters")  // Filter items where 'sub' equals "attackingOpenGuard"
              .map((item) => (
...
export default passingHeadquarters;
